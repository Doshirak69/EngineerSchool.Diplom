...
namespace TemplateDesignerExtension
{
    ...
    class TemplateDesignerExtension : WebLayoutsDesignerExtension
    {
        ...
        protected override Dictionary<string, PropertyDescription> GetPropertyDescriptions()
        {
            ...
            {
                {"TicketPriceField", GetTicketPriceFieldPropertyDescription()}
            };
        }
        ...
        private ControlTypeDescription GetRequestTicketPriceControl()
        {
            return new ControlTypeDescription("GetRequestTicketPriceControl")
            {
                DisplayName = "Получение списка билетов",
                ControlGroupDisplayName = "Пользовательские контролы",
                PropertyDescriptions =
                {
                    PropertyFactory.GetNameProperty(),
                    PropertyFactory.GetVisibilityProperty(),
                    PropertyFactory.GetClickEvent(),
                    PropertyFactory.Create("TicketPriceField")
                }
            };
        }
        private PropertyDescription GetTicketPriceFieldPropertyDescription()
        {
            return new PropertyDescription()
            {
                Name = "TicketPriceField",
                DisplayName = "Поле для стоимости билета",
                Type = typeof(string),
